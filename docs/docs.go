        ...
        "/admin/restaurants": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter theo package_status",
                        "name": "package_status",
                        "in": "query"
                    },
                    {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.UpdateMenuItemInput"
                        }
                    }
                ],
                "responses": {
        ...
        "/orders/{id}/items": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Danh sách món thêm",
                        "name": "items",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.AddOrderItemsInput"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.PayOrderInput"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.UpdateOrderStatusInput"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.UpdateRestaurantInput"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.CreateMenuItemInput"
                        }
                    }
                ],
                "responses": {
        ...
        "/restaurants/{id}/orders": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter theo ngày (YYYY-MM-DD)",
                        "name": "date",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "Filter theo bàn",
                        "name": "table_id",
                        "in": "query"
                    },
                    {
        ...
        "/restaurants/{id}/tables": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "Filter theo is_active",
                        "name": "is_active",
                        "in": "query"
                    }
                ],
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Thông tin bàn",
                        "name": "table",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.CreateTableInput"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.UpdateTableInput"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "handlers.AddOrderItemsInput": {
            ...
            "properties": {
                "items": {
                    ...
                    "minItems": 1,
                    "items": {
                        "$ref": "#/definitions/handlers.OrderItemInput"
                    }
                }
            }
        },
        ...
        "handlers.CreateOrderInput": {
            ...
            "properties": {
                ...
                "payment_method": {
                    "description": "cash, qr, momo, vnpay",
                    "type": "string"
                },
                "table_number": {
                    "type": "integer"
        ...
        "handlers.UpdateOrderStatusInput": {
            "type": "object",
            "required": [
                "status"
            ],
        ...
        "handlers.UpdateRestaurantInput": {
            "type": "object",
            "properties": {
                "address": {
                    "type": "string"
